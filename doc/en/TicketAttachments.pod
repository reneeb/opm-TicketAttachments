...
TicketAttachments - handle attachments of a ticket
...
The admin can define a list of filenames that should not appear in the widget. That way,
signatures (like I<smime.p7s>) do not fill the list of attachments
...
=item * Simple reuse of Attachments in Compose and/or Forware dialog
...
Copyright (c) 2012 - 2014 Renee Baecker (Perl-Services.de)
